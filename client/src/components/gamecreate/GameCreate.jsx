...
import { postGame, getByGenres, getPlatform } from "../../redux/actions/index";
        ...
        <div className={s.firstContainerForm}>
          <NavLink to="/home">
            <div className={s.buttonContainer}>
              <button className={s.buttonForm}>Volver a Home</button>
            </div>
          </NavLink>

          <div className={s.containerForm}>
            <h2 className={s.titulo}>Crea tu juego!</h2>
            ...
            <form className={s.form} onSubmit={(event) => handleSubmit(event)}>
              <div className={s.form_group}>
                ...
                ></input>
                {errors.name && <p className={s.red}>{errors.name}</p>}
              </div>
              ...
              <div className={s.form_group}>
                ...
                <input
                  ...
                  onChange={(event) => handleChange(event)}
                ></input>
                {errors.released && <p className={s.red}>{errors.released}</p>}
              </div>
              ...
              <div className={s.form_group}>
                ...
                <input
                  ...
                  onChange={(event) => handleChange(event)}
                ></input>
                {errors.rating && <p className={s.red}>{errors.rating}</p>}
              </div>
